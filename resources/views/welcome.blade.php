...
<body>
    ...
    <section class="band">
        <div class="wrap">
            ...
            <div class="modules">
                ...
                <article class="module">
                    <h3 class="module-name">Смета<span class="module-tag">объём и цена</span></h3>
                    <div class="module-body">
                        <p>Открывается из карточки клиента и сама подтягивает бизнес-процессы, обязательные и рекомендованные для его налогового режима, считая цену по тарифу и справочнику ставок. Смета здесь не просто прайс: именно из её строк потом рождаются задачи бухгалтеру и суммы в акте.</p>
                        <ul class="inside">
                            <li>подбор БП под режим</li>
                            <li>расчёт стоимости</li>
                            <li>печатная смета для клиента</li>
                            <li>исполнитель на каждый БП</li>
                        </ul>
                    </div>
                </article>
                ...
                <article class="module">
                    <h3 class="module-name">БухСмета<span class="module-tag">деньги месяца</span></h3>
                    <div class="module-body">
                        <p>Деньги в разрезе клиентов: что фактически сделано за месяц и на какую сумму по каждой компании. Отсюда же печатается АВР: акт выполненных работ собирается из реально закрытых задач, а не набивается заново.</p>
                        <ul class="inside">
                            <li>факт месяца по клиенту</li>
                            <li>акт на печать</li>
                            <li>плановые и внеплановые работы</li>
                        </ul>
                    </div>
                </article>
    ...
    <section class="dark closing">
        <div class="wrap">
            <h2>Посмотреть, как это работает на ваших клиентах</h2>
            <p>Каждая фирма работает в своём изолированном аккаунте: клиенты, сотрудники, сметы и справочники одной фирмы недоступны другой. Аккаунт заводится со стартовым набором справочников, так что система готова к работе сразу, остаётся загрузить своих клиентов.</p>
