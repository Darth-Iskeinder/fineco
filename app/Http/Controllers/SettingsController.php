...
class SettingsController extends Controller
{
     ...
     *  - биллинг и ставка наследуются, чтобы строка считалась в смете по цене родителя;
     *  - количества у подпункта нет: и в смете, и в задаче число одно, на основном БП,
     *    а подпункт только говорит, входит эта часть работы в состав или нет;
    ...
    public function storeService(Request $request)
    {
        $request->validate([
            ...
            'service_type'                  => ['nullable', 'string', Rule::in(array_keys(Service::SERVICE_TYPES))],
